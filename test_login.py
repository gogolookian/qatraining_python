...
class LoginTests(unittest.TestCase):
    ...
    def setUp(self):
        app = ('/Users/Ian/Library/Developer/Xcode/DerivedData/AppiumTest-fzgbcylmzgvirbheutedffbhuooy/Build/Products/Debug-iphonesimulator/AppiumTest.app')
        self.driver = webdriver.Remote(
            command_executor='http://127.0.0.1:8787/wd/hub',
            desired_capabilities={
                'app': app,
                'platformName': 'iOS',
                'platformVersion': '10.0',
                'deviceName': 'iPhone 7 - iOS10'
            }
        )
    ...
    def testEmailField(self):
        ...
        emailTF.send_keys("ian@gogolook.com")
        emailTF.send_keys(Keys.RETURN)
        sleep(1)
        self.assertEqual(emailTF.get_attribute("value"), "ian@gogolook.com")
